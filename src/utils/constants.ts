...
export default {
  ...
  questionNicknameForBoard: (minutesToAnswer: number) => `[⚔️] *Luta*\n_Digite seu nickname!_ (*${minutesToAnswer} minutos* para responder)`,
  questionEnemyNicknameForBoard: (minutesToAnswer: number) => `[⚔️] *Luta*\n_Oponente, digite seu nickname!_ (*${minutesToAnswer} minutos* para responder)`,
  noResponseReceived: '[⌛] *Fim do tempo*\n> Nenhuma resposta recebida!',
  turnToPlay: (nickname: string) => `[⚔️] *Atenção*\n*${nickname}* é a sua vez de jogar!\n> *3 minutos ⏰*`,
  alreadyPlayedCard: (nickname: string) => `[⚔️] *Atenção*\n*${nickname}* você já usou esta carta!`,
  playerLoseByWO: (nickname: string) => `[⛔] *DERROTA*\n*${nickname}* perdeu por inatividade (W.O)!`
};
